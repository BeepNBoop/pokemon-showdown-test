...
export class TeamValidator {
	...
	validateSet(set: PokemonSet, teamHas: AnyObject): string[] | null {
		...
		if (ruleTable.has('draft3rules') && species.id === 'magearna' && 
		...
		if (ruleTable.has('draft3rules') && species.id === 'magearna' && !item.isPokeball) {
			problems.push(`${name} must hold some form of pokeball as an item.`);
		}
		if (ruleTable.has('draft3rules') && 
		((set.moves.includes('custommovebug') && set.moves.includes('custommovedark')) || 
		(set.moves.includes('custommovebug') && set.moves.includes('custommovedragon')) || 
		(set.moves.includes('custommovebug') && set.moves.includes('custommoveelectric')) || 
		(set.moves.includes('custommovebug') && set.moves.includes('custommovefairy')) || 
		(set.moves.includes('custommovebug') && set.moves.includes('custommovefighting')) || 
		(set.moves.includes('custommovebug') && set.moves.includes('custommovefire')) || 
		(set.moves.includes('custommovebug') && set.moves.includes('custommoveflying')) || 
		(set.moves.includes('custommovebug') && set.moves.includes('custommoveghost')) || 
		(set.moves.includes('custommovebug') && set.moves.includes('custommovegrass')) || 
		(set.moves.includes('custommovebug') && set.moves.includes('custommoveground')) || 
		(set.moves.includes('custommovebug') && set.moves.includes('custommoveice')) || 
		(set.moves.includes('custommovebug') && set.moves.includes('custommovepoison')) || 
		(set.moves.includes('custommovebug') && set.moves.includes('custommovepsychic')) || 
		(set.moves.includes('custommovebug') && set.moves.includes('custommoverock')) || 
		(set.moves.includes('custommovebug') && set.moves.includes('custommovesteel')) || 
		(set.moves.includes('custommovebug') && set.moves.includes('custommovewater')) || 
		(set.moves.includes('custommovedark') && set.moves.includes('custommovedragon')) || 
		(set.moves.includes('custommovedark') && set.moves.includes('custommoveelectric')) || 
		(set.moves.includes('custommovedark') && set.moves.includes('custommovefairy')) || 
		(set.moves.includes('custommovedark') && set.moves.includes('custommovefighting')) || 
		(set.moves.includes('custommovedark') && set.moves.includes('custommovefire')) || 
		(set.moves.includes('custommovedark') && set.moves.includes('custommoveflying')) || 
		(set.moves.includes('custommovedark') && set.moves.includes('custommoveghost')) || 
		(set.moves.includes('custommovedark') && set.moves.includes('custommovegrass')) || 
		(set.moves.includes('custommovedark') && set.moves.includes('custommoveground')) || 
		(set.moves.includes('custommovedark') && set.moves.includes('custommoveice')) || 
		(set.moves.includes('custommovedark') && set.moves.includes('custommovepoison')) || 
		(set.moves.includes('custommovedark') && set.moves.includes('custommovepsychic')) || 
		(set.moves.includes('custommovedark') && set.moves.includes('custommoverock')) || 
		(set.moves.includes('custommovedark') && set.moves.includes('custommovesteel')) || 
		(set.moves.includes('custommovedark') && set.moves.includes('custommovewater')) ||  
		(set.moves.includes('custommovedragon') && set.moves.includes('custommoveelectric')) || 
		(set.moves.includes('custommovedragon') && set.moves.includes('custommovefairy')) || 
		(set.moves.includes('custommovedragon') && set.moves.includes('custommovefighting')) || 
		(set.moves.includes('custommovedragon') && set.moves.includes('custommovefire')) || 
		(set.moves.includes('custommovedragon') && set.moves.includes('custommoveflying')) || 
		(set.moves.includes('custommovedragon') && set.moves.includes('custommoveghost')) || 
		(set.moves.includes('custommovedragon') && set.moves.includes('custommovegrass')) || 
		(set.moves.includes('custommovedragon') && set.moves.includes('custommoveground')) || 
		(set.moves.includes('custommovedragon') && set.moves.includes('custommoveice')) || 
		(set.moves.includes('custommovedragon') && set.moves.includes('custommovepoison')) || 
		(set.moves.includes('custommovedragon') && set.moves.includes('custommovepsychic')) || 
		(set.moves.includes('custommovedragon') && set.moves.includes('custommoverock')) || 
		(set.moves.includes('custommovedragon') && set.moves.includes('custommovesteel')) || 
		(set.moves.includes('custommovedragon') && set.moves.includes('custommovewater')) || 
		(set.moves.includes('custommoveelectric') && set.moves.includes('custommovefairy')) || 
		(set.moves.includes('custommoveelectric') && set.moves.includes('custommovefighting')) || 
		(set.moves.includes('custommoveelectric') && set.moves.includes('custommovefire')) || 
		(set.moves.includes('custommoveelectric') && set.moves.includes('custommoveflying')) || 
		(set.moves.includes('custommoveelectric') && set.moves.includes('custommoveghost')) || 
		(set.moves.includes('custommoveelectric') && set.moves.includes('custommovegrass')) || 
		(set.moves.includes('custommoveelectric') && set.moves.includes('custommoveground')) || 
		(set.moves.includes('custommoveelectric') && set.moves.includes('custommoveice')) || 
		(set.moves.includes('custommoveelectric') && set.moves.includes('custommovepoison')) || 
		(set.moves.includes('custommoveelectric') && set.moves.includes('custommovepsychic')) || 
		(set.moves.includes('custommoveelectric') && set.moves.includes('custommoverock')) || 
		(set.moves.includes('custommoveelectric') && set.moves.includes('custommovesteel')) || 
		(set.moves.includes('custommoveelectric') && set.moves.includes('custommovewater')) || 
		(set.moves.includes('custommovefairy') && set.moves.includes('custommovefighting')) || 
		(set.moves.includes('custommovefairy') && set.moves.includes('custommovefire')) || 
		(set.moves.includes('custommovefairy') && set.moves.includes('custommoveflying')) || 
		(set.moves.includes('custommovefairy') && set.moves.includes('custommoveghost')) || 
		(set.moves.includes('custommovefairy') && set.moves.includes('custommovegrass')) || 
		(set.moves.includes('custommovefairy') && set.moves.includes('custommoveground')) || 
		(set.moves.includes('custommovefairy') && set.moves.includes('custommoveice')) || 
		(set.moves.includes('custommovefairy') && set.moves.includes('custommovepoison')) || 
		(set.moves.includes('custommovefairy') && set.moves.includes('custommovepsychic')) || 
		(set.moves.includes('custommovefairy') && set.moves.includes('custommoverock')) || 
		(set.moves.includes('custommovefairy') && set.moves.includes('custommovesteel')) || 
		(set.moves.includes('custommovefairy') && set.moves.includes('custommovewater')) || 
		(set.moves.includes('custommovefighting') && set.moves.includes('custommovefire')) || 
		(set.moves.includes('custommovefighting') && set.moves.includes('custommoveflying')) || 
		(set.moves.includes('custommovefighting') && set.moves.includes('custommoveghost')) || 
		(set.moves.includes('custommovefighting') && set.moves.includes('custommovegrass')) || 
		(set.moves.includes('custommovefighting') && set.moves.includes('custommoveground')) || 
		(set.moves.includes('custommovefighting') && set.moves.includes('custommoveice')) || 
		(set.moves.includes('custommovefighting') && set.moves.includes('custommovepoison')) || 
		(set.moves.includes('custommovefighting') && set.moves.includes('custommovepsychic')) || 
		(set.moves.includes('custommovefighting') && set.moves.includes('custommoverock')) || 
		(set.moves.includes('custommovefighting') && set.moves.includes('custommovesteel')) || 
		(set.moves.includes('custommovefighting') && set.moves.includes('custommovewater')) ||
		(set.moves.includes('custommovefire') && set.moves.includes('custommoveflying')) || 
		(set.moves.includes('custommovefire') && set.moves.includes('custommoveghost')) || 
		(set.moves.includes('custommovefire') && set.moves.includes('custommovegrass')) || 
		(set.moves.includes('custommovefire') && set.moves.includes('custommoveground')) || 
		(set.moves.includes('custommovefire') && set.moves.includes('custommoveice')) || 
		(set.moves.includes('custommovefire') && set.moves.includes('custommovepoison')) || 
		(set.moves.includes('custommovefire') && set.moves.includes('custommovepsychic')) || 
		(set.moves.includes('custommovefire') && set.moves.includes('custommoverock')) || 
		(set.moves.includes('custommovefire') && set.moves.includes('custommovesteel')) || 
		(set.moves.includes('custommovefire') && set.moves.includes('custommovewater')) || 
		(set.moves.includes('custommoveflying') && set.moves.includes('custommoveghost')) || 
		(set.moves.includes('custommoveflying') && set.moves.includes('custommovegrass')) || 
		(set.moves.includes('custommoveflying') && set.moves.includes('custommoveground')) || 
		(set.moves.includes('custommoveflying') && set.moves.includes('custommoveice')) || 
		(set.moves.includes('custommoveflying') && set.moves.includes('custommovepoison')) || 
		(set.moves.includes('custommoveflying') && set.moves.includes('custommovepsychic')) || 
		(set.moves.includes('custommoveflying') && set.moves.includes('custommoverock')) || 
		(set.moves.includes('custommoveflying') && set.moves.includes('custommovesteel')) || 
		(set.moves.includes('custommoveflying') && set.moves.includes('custommovewater')) || 
		(set.moves.includes('custommoveghost') && set.moves.includes('custommoveground')) ||
		(set.moves.includes('custommoveghost') && set.moves.includes('custommovegrass')) || 
		(set.moves.includes('custommoveghost') && set.moves.includes('custommoveice')) || 
		(set.moves.includes('custommoveghost') && set.moves.includes('custommovepoison')) || 
		(set.moves.includes('custommoveghost') && set.moves.includes('custommovepsychic')) || 
		(set.moves.includes('custommoveghost') && set.moves.includes('custommoverock')) || 
		(set.moves.includes('custommoveghost') && set.moves.includes('custommovesteel')) || 
		(set.moves.includes('custommoveghost') && set.moves.includes('custommovewater')) || 
		(set.moves.includes('custommovegrass') && set.moves.includes('custommoveground')) || 
		(set.moves.includes('custommovegrass') && set.moves.includes('custommoveice')) ||
		(set.moves.includes('custommovegrass') && set.moves.includes('custommovepoison')) || 
		(set.moves.includes('custommovegrass') && set.moves.includes('custommovepsychic')) || 
		(set.moves.includes('custommovegrass') && set.moves.includes('custommoverock')) || 
		(set.moves.includes('custommovegrass') && set.moves.includes('custommovesteel')) || 
		(set.moves.includes('custommovegrass') && set.moves.includes('custommovewater')) || 
		(set.moves.includes('custommoveground') && set.moves.includes('custommoveice')) || 
		(set.moves.includes('custommoveground') && set.moves.includes('custommovepoison')) || 
		(set.moves.includes('custommoveground') && set.moves.includes('custommovepsychic')) ||
		(set.moves.includes('custommoveground') && set.moves.includes('custommoverock')) || 
		(set.moves.includes('custommoveground') && set.moves.includes('custommovesteel')) || 
		(set.moves.includes('custommoveground') && set.moves.includes('custommovewater')) || 
		(set.moves.includes('custommoveice') && set.moves.includes('custommovepoison')) || 
		(set.moves.includes('custommoveice') && set.moves.includes('custommovepsychic')) || 
		(set.moves.includes('custommoveice') && set.moves.includes('custommoverock')) || 
		(set.moves.includes('custommoveice') && set.moves.includes('custommovesteel')) ||
		(set.moves.includes('custommoveice') && set.moves.includes('custommovewater')) || 
		(set.moves.includes('custommovepoison') && set.moves.includes('custommovepsychic')) || 
		(set.moves.includes('custommovepoison') && set.moves.includes('custommoverock')) || 
		(set.moves.includes('custommovepoison') && set.moves.includes('custommovesteel')) || 
		(set.moves.includes('custommovepoison') && set.moves.includes('custommovewater')) || 
		(set.moves.includes('custommovepsychic') && set.moves.includes('custommoverock')) || 
		(set.moves.includes('custommovepsychic') && set.moves.includes('custommovesteel')) || 
		(set.moves.includes('custommovepsychic') && set.moves.includes('custommovewater')) || 
		(set.moves.includes('custommoverock') && set.moves.includes('custommovesteel')) || 
		(set.moves.includes('custommoverock') && set.moves.includes('custommovewater')) || 
		(set.moves.includes('custommovesteel') && set.moves.includes('custommovewater')))) {
			problems.push(`You may only have 1 type of custom move on a team.`);
		}
		...
		if (ruleTable.has('draft3rules') && species.id === 'kommoo' && set.moves.includes('clangoroussoul')) {
